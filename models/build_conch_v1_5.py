...
class Conch_V1_5_Attention(nn.Module):
...
class Block(nn.Module):
    def __init__(
        ...
        self.attn = Conch_V1_5_Attention(
            dim,
            num_heads=num_heads,
            qkv_bias=qkv_bias,
            qk_norm=qk_norm,
...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            attn_drop_rate: Conch_V1_5_Attention dropout rate.
...
class Conch_V1_5_AttentionalPooler(nn.Module):
    def __init__(
            self,
            d_model: int,
            context_dim: int,
...
class EncoderWithConch_V1_5_AttentionalPooler(nn.Module):
    def __init__(
        self,
        encoder,
